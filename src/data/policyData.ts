...
export const policyRecords: PolicyRecord[] = stateTiles.map((tile) => {
  ...
  if (canonicalMatch) {
    ...
    return {
      ...
      sourceIntegrityStatus: canonicalMatch.source_integrity_status ?? undefined,
      sourceIntegrityCheckedAt: canonicalMatch.source_integrity_checked_at ?? undefined,
  ...
  return {
    ...
    sourceIntegrityStatus: undefined,
    sourceIntegrityCheckedAt: undefined,
    routingReasons: [],
